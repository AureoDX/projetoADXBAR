...
public class FahítaDao {
    
   //Depósito em Fahíta: 
    
   public FahítaBean salvarFahíta (FahítaBean boo) throws SQLException{
        
        Connection conn = ConnectionFactory.getConnection();
        PreparedStatement stmt = null;
        try {
            
        stmt = conn.prepareStatement("INSERT INTO fahíta (descricao, nome, valor_da_compra, moeda, unidade, data) values(?,?,?,?,?, TO_CHAR(current_date, 'DD-MM-YYYY'))");      
   ...
   // Listar Fahíta na Tabela:
   
   public List<FahítaBean> CervejaB() throws SQLException{
     Connection conn = ConnectionFactory.getConnection();
     PreparedStatement stmt = null;   
     ResultSet rst = null;    
     
        List<FahítaBean> cervejab = new ArrayList<>();
        try {
         stmt = conn.prepareStatement("SELECT * FROM fahíta");
         
         rst = stmt.executeQuery();
            
            while(rst.next()) {
            
            FahítaBean crj = new FahítaBean();
       ...
       // JOptionPane.showMessageDialog(null, "Dados inseridos com Sucesso no Fahíta!!");
      ...
      //Comando de Deletar da Tabela Fahíta:
    
      public void delete(FahítaBean dlb) throws SQLException{
        
     Connection conn = ConnectionFactory.getConnection();
     PreparedStatement stmt = null;   
     
        try {
         stmt = conn.prepareStatement("DELETE FROM fahíta where id= ? ");
