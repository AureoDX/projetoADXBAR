...
public class TelaHamburguer extends javax.swing.JFrame {
    ...
    public TelaHamburguer() {
     ...
     this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/imagens/ADXBAR tamanho grande.jpg")).getImage());
        ...
        try {
            ...
            Logger.getLogger(TelaHamburguer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
   ...
   private void calcularHamburguer(){
     ...
     //Mostrar valores de Hamburguer na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaHamburguer.getModel(); 
       modelo.setNumRows(0);
       
       HamburguerDao bdao = new HamburguerDao();
       for(HamburguerBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Hamburguer:
    
     private void gerarRelatórioHamburguer() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from hamburguer";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioHamburguerADXBAR_1.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaHamburguer = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(206, 108, 1));

        jTabelaHamburguer.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaHamburguer);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaComida/Hamburguer Branco~1.jpg"))); // NOI18N
        ...
        txtValordaCompra.setBackground(new java.awt.Color(206, 108, 1));
        ...
        txtUnidade.setBackground(new java.awt.Color(206, 108, 1));
        ...
        txtTroco.setBackground(new java.awt.Color(206, 108, 1));
        ...
        btnVer.setBackground(new java.awt.Color(206, 108, 1));
        ...
        btnDeletar.setBackground(new java.awt.Color(206, 108, 1));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(206, 108, 1));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(btnVer, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        // Linha de Cód. de Salvar Hamburguer:

        HamburguerBean bb = new HamburguerBean();
        HamburguerDao bdao = new HamburguerDao();
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    bdao.salvarHamburguer(bb);

                    JOptionPane.showMessageDialog(null, "HAMBURGUER, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro HAMBURGUER ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        HamburguerDao bdao = new HamburguerDao();
        HamburguerBean bda = new HamburguerBean();

        if(jTabelaHamburguer.getSelectedRow() != -1){

            bda.setId((int) jTabelaHamburguer.getValueAt(jTabelaHamburguer.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaHamburguer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaHamburguer().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTabelaHamburguer;
