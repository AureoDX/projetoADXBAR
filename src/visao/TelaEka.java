...
public class TelaEka extends javax.swing.JFrame {
   ...
   private void calcularEka(){
     ...
     //Mostrar valores de Eka na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaEka.getModel(); 
       modelo.setNumRows(0);
       
       EkaDao bdao = new EkaDao();
       for(EkaBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório EKA:
     ...
     private void gerarRelatórioEka() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade,data from eka";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioEkaADXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaEka = new javax.swing.JTable();
        ...
        jTabelaEka.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaEka);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaBebida/Eka~3.jpg"))); // NOI18N
        ...
        btnVer.setBackground(new java.awt.Color(1, 66, 150));
        ...
        btnDeletar.setBackground(new java.awt.Color(1, 66, 150));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(1, 66, 150));
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "EKA, compra feita com Sucesso! ");
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        EkaDao bdao = new EkaDao();
        EkaBean bda = new EkaBean();

        if(jTabelaEka.getSelectedRow() != -1){

            bda.setId((int) jTabelaEka.getValueAt(jTabelaEka.getSelectedRow(), 0));

            try {
                bdao.delete(bda);
            } catch (SQLException ex) {
                Logger.getLogger(TelaEka.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEka.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTabelaEka;
