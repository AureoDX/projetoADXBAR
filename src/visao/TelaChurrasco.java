...
public class TelaChurrasco extends javax.swing.JFrame {
 
    public TelaChurrasco() {
        initComponents();
        limitarnum();
     ...
     this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/imagens/ADXBAR tamanho grande.jpg")).getImage());
        ...
        try {
            ...
            Logger.getLogger(TelaChurrasco.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
   ...
   private void calcularChurrasco(){
     ...
     //Mostrar valores de Churrasco na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaChurrasco.getModel(); 
       modelo.setNumRows(0);
       
       ChurrascoDao bdao = new ChurrascoDao();
       for(ChurrascoBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Churrasco:
    
     private void gerarRelatórioChurrasco() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from churrasco";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioChurrascoADXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaChurrasco = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(255, 191, 13));

        jTabelaChurrasco.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaChurrasco);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaComida/Churrasco branco~1.jpg"))); // NOI18N
        ...
        txtValordaCompra.setBackground(new java.awt.Color(255, 191, 13));
        ...
        txtUnidade.setBackground(new java.awt.Color(255, 191, 13));
        ...
        txtTroco.setBackground(new java.awt.Color(255, 191, 13));
        ...
        btnVer.setBackground(new java.awt.Color(255, 191, 13));
        ...
        btnDeletar.setBackground(new java.awt.Color(255, 191, 13));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(255, 191, 13));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        // Linha de Cód. de Salvar Churrasco:

        ChurrascoBean bb = new ChurrascoBean();
        ChurrascoDao bdao = new ChurrascoDao();

        String descrição = "COMIDA";
        String nome = "CHURRASCO";
        String moeda ="AKZ";
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    bdao.salvarChurrasco(bb);

                    JOptionPane.showMessageDialog(null, "CHURRASCO, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro CHURRASCO ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        ChurrascoDao bdao = new ChurrascoDao();
        ChurrascoBean bda = new ChurrascoBean();

        if(jTabelaChurrasco.getSelectedRow() != -1){

            bda.setId((int) jTabelaChurrasco.getValueAt(jTabelaChurrasco.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaChurrasco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaChurrasco().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTabelaChurrasco;
