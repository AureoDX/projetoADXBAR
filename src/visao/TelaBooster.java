...
public class TelaBooster extends javax.swing.JFrame {
   ...
   private void calcularBooster(){
     ...
     //Mostrar valores de Booster na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaBooster.getModel(); 
       modelo.setNumRows(0);
       
       BoosterDao bdao = new BoosterDao();
       for(BoosterBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Booster:
     ...
     private void gerarRelatórioBooster() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from Booster";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioBoosterADXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaBooster = new javax.swing.JTable();
        ...
        setPreferredSize(new java.awt.Dimension(733, 517));
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(33, 147, 0));

        jTabelaBooster.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaBooster);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaBebida/Booster~1.jpg"))); // NOI18N
        ...
        txtValordaCompra.setBackground(new java.awt.Color(33, 147, 0));
        ...
        txtUnidade.setBackground(new java.awt.Color(33, 147, 0));
        ...
        txtTroco.setBackground(new java.awt.Color(33, 147, 0));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtUnidade, javax.swing.GroupLayout.DEFAULT_SIZE, 137, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
                        .addComponent(jSpinnerUnidade, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE))
        ...
        btnVer.setBackground(new java.awt.Color(33, 147, 0));
        ...
        btnDeletar.setBackground(new java.awt.Color(33, 147, 0));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(33, 147, 0));
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        BoosterDao bdao = new BoosterDao();
        BoosterBean bda = new BoosterBean();

        if(jTabelaBooster.getSelectedRow() != -1){

            bda.setId((int) jTabelaBooster.getValueAt(jTabelaBooster.getSelectedRow(), 0));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        BoosterBean bb = new BoosterBean();
        BoosterDao bdao = new BoosterDao();
        ...
        JOptionPane.showMessageDialog(null, "Valor não aceite!");
            ...
            bb.setTroco(txtTroco.getText());
        
     try {
    
    bdao.salvarBooster(bb);
    
    JOptionPane.showMessageDialog(null, "BOOSTER, compra feita com Sucesso! ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBooster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaBooster().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTabelaBooster;
