...
public class TelaCachorro extends javax.swing.JFrame {
    ...
    public TelaCachorro() {
     ...
     this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/imagens/ADXBAR tamanho grande.jpg")).getImage());
        ...
        try {
            ...
            Logger.getLogger(TelaCachorro.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
   ...
   private void calcularCachorro(){
     ...
     //Mostrar valores de Cachorro na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaCachorro.getModel(); 
       modelo.setNumRows(0);
       
       CachorroDao bdao = new CachorroDao();
       for(CachorroBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Cachorro:
    
     private void gerarRelatórioCachorro() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from cachorro";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioCachorroADXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaCachorro = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(198, 40, 1));

        jTabelaCachorro.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaCachorro);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaComida/Cachorro Quente~1.jpg"))); // NOI18N
        ...
        txtValordaCompra.setBackground(new java.awt.Color(198, 40, 1));
        ...
        txtUnidade.setBackground(new java.awt.Color(198, 40, 1));
        ...
        txtTroco.setBackground(new java.awt.Color(198, 40, 1));
        ...
        btnVer.setBackground(new java.awt.Color(198, 40, 1));
        ...
        btnDeletar.setBackground(new java.awt.Color(198, 40, 1));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(198, 40, 1));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        CachorroBean bb = new CachorroBean();
        CachorroDao bdao = new CachorroDao();
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    bdao.salvarCachorro(bb);

                    JOptionPane.showMessageDialog(null, "CACHORRO QUENTE, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro Cachorro ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        CachorroDao bdao = new CachorroDao();
        CachorroBean bda = new CachorroBean();

        if(jTabelaCachorro.getSelectedRow() != -1){

            bda.setId((int) jTabelaCachorro.getValueAt(jTabelaCachorro.getSelectedRow(), 0));
    ...
    private javax.swing.JTable jTabelaCachorro;
