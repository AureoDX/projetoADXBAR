...
public class TelaNocal extends javax.swing.JFrame {
   ...
   private void calcularNocal(){
     ...
     //Mostrar valores de Nocal na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaNocal.getModel(); 
       modelo.setNumRows(0);
       
       NocalDao bdao = new NocalDao();
       for(NocalBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Nocal:
    
     private void gerarRelatórioNocal() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from nocal";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioNocalADXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaNocal = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(219, 34, 39));

        jTabelaNocal.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaNocal);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaBebida/Nocal~3.jpg"))); // NOI18N
        ...
        txtValordaCompra.setBackground(new java.awt.Color(219, 34, 39));
        ...
        txtUnidade.setBackground(new java.awt.Color(219, 34, 39));
        ...
        txtTroco.setBackground(new java.awt.Color(219, 34, 39));
        ...
        btnVer.setBackground(new java.awt.Color(219, 34, 39));
        ...
        btnDeletar.setBackground(new java.awt.Color(219, 34, 39));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(219, 34, 39));
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "NOCAL, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro Nocal ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
        try {
            ...
            Logger.getLogger(TelaNocal.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        NocalDao bdao = new NocalDao();
        NocalBean bda = new NocalBean();

        if(jTabelaNocal.getSelectedRow() != -1){

            bda.setId((int) jTabelaNocal.getValueAt(jTabelaNocal.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaNocal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTabelaNocal;
