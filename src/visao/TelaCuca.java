...
public class TelaCuca extends javax.swing.JFrame {
   ...
   private void calcularCuca(){
     ...
     //Mostrar valores de Cuca na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaCuca.getModel(); 
       modelo.setNumRows(0);
       
       CucaDao bdao = new CucaDao();
       for(CucaBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório CUCA:
    
     private void gerarRelatórioCuca() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from cuca";
    ...
    private void initComponents() {
        ...
        jTabelaCuca = new javax.swing.JTable();
        ...
        jTabelaCuca.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaCuca);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaBebida/Cuca~3.jpg"))); // NOI18N
        ...
        btnVer.setBackground(new java.awt.Color(241, 10, 20));
        ...
        btnDeletar.setBackground(new java.awt.Color(241, 10, 20));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(241, 10, 20));
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "CUCA, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro Cuca ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
        try {
            ...
            Logger.getLogger(TelaCuca.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        CucaDao bdao = new CucaDao();
        CucaBean bda = new CucaBean();

        if(jTabelaCuca.getSelectedRow() != -1){

            bda.setId((int) jTabelaCuca.getValueAt(jTabelaCuca.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCuca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTabelaCuca;
