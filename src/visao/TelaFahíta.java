...
public class TelaFahíta extends javax.swing.JFrame {
    ...
    public TelaFahíta() {
     ...
     this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/imagens/ADXBAR tamanho grande.jpg")).getImage());
        ...
        try {
            ...
            Logger.getLogger(TelaFahíta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
   ...
   private void calcularFahíta(){
     ...
     //Mostrar valores de Fahíta na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaFahíta.getModel(); 
       modelo.setNumRows(0);
       
       FahítaDao bdao = new FahítaDao();
       for(FahítaBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Fahíta:
    
     private void gerarRelatórioFahíta() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from fahíta";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioFahítaADXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaFahíta = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(245, 228, 0));

        jTabelaFahíta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaFahíta);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaComida/Faíta Branco~1.jpg"))); // NOI18N

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setPreferredSize(new java.awt.Dimension(544, 294));

        jLabel2.setFont(new java.awt.Font("Tw Cen MT", 1, 24)); // NOI18N
        jLabel2.setText("Valor da compra :");

        txtValordaCompra.setBackground(new java.awt.Color(245, 228, 0));
        ...
        txtUnidade.setBackground(new java.awt.Color(245, 228, 0));
        ...
        txtTroco.setBackground(new java.awt.Color(245, 228, 0));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        .addGap(57, 57, 57)
                        .addComponent(btnConfirmar, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
        ...
        btnVer.setBackground(new java.awt.Color(245, 228, 0));
        ...
        btnDeletar.setBackground(new java.awt.Color(245, 228, 0));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(245, 228, 0));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        // Linha de Cód. de Salvar Fahíta:

        FahítaBean bb = new FahítaBean();
        FahítaDao bdao = new FahítaDao();
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    bdao.salvarFahíta(bb);

                    JOptionPane.showMessageDialog(null, "FAHÍTA, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro FAHÍTA ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        FahítaDao bdao = new FahítaDao();
        FahítaBean bda = new FahítaBean();

        if(jTabelaFahíta.getSelectedRow() != -1){

            bda.setId((int) jTabelaFahíta.getValueAt(jTabelaFahíta.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFahíta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaFahíta().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTabelaFahíta;
