...
import controle.BoosterDao;
import controle.CocaColaDao;
...
public class TelaCocaCola extends javax.swing.JFrame {
   ...
   private void calcularCocaCola(){
     ...
     //Mostrar valores de CocaCola na Tabela:
    
    public void oListar() throws SQLException {
        
       DefaultTableModel modelo = (DefaultTableModel) jTabelaCocaCola.getModel(); 
       modelo.setNumRows(0);
       
       CocaColaDao bdao = new CocaColaDao();
       for(CocaColaBean b: bdao.CervejaB()) {
    ...
    //Gerar Relatório Booster:
    
     private void gerarRelatórioCocaCola() throws SQLException, JRException {  
         
       Connection conn = ConnectionFactory.getConnection();
       
       String sql ="select id, descricao, nome, valor_da_compra, moeda, unidade, data from cocacola";
       
       JasperPrint jaspertPrint = null;
       
       //Caminho Relatório:
     
      InputStream caminhoRelatório = this.getClass().getClassLoader().getResourceAsStream("relatórioADXBAR/relatórioCocaColaDXBAR.jasper");
      try {
    ...
    private void initComponents() {
        ...
        jTabelaCocaCola = new javax.swing.JTable();
        ...
        jPanel1.setBackground(new java.awt.Color(199, 0, 21));

        jTabelaCocaCola.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabelaCocaCola);

        jImagem.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jImagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagensTelaBebida/Coca-Cola~3.jpg"))); // NOI18N
        jImagem.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        txtValordaCompra.setBackground(new java.awt.Color(199, 0, 21));
        ...
        txtUnidade.setBackground(new java.awt.Color(199, 0, 21));
        ...
        txtTroco.setBackground(new java.awt.Color(199, 0, 21));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/beer_121476.png"))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jSpinnerUnidade, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnVer.setBackground(new java.awt.Color(199, 0, 21));
        ...
        btnDeletar.setBackground(new java.awt.Color(199, 0, 21));
        ...
        btnGerarRelatório.setBackground(new java.awt.Color(199, 0, 21));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        // Linha de Cód. de Salvar valores Booster:

        CocaColaBean bb = new CocaColaBean();
        CocaColaDao bdao = new CocaColaDao();

        String descrição = "BEBIDA";
        String nome = "COCACOLA";
        String moeda ="AKZ";
        ...
        if(txtValordaCompra.getText().equals("")) {
            ...
            if( num2 < num ) {
                ...
                try {
                    ...
                    bdao.salvarCocaCola(bb);

                    JOptionPane.showMessageDialog(null, "COCA-COLA, compra feita com Sucesso! ");

                } catch (SQLException ex) {
                    JOptionPane.showMessageDialog(null, "Erro Booster ao Depositar o Valor! /n  Erro: !!"+ex.getMessage());
                }
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
        try {
            ...
            Logger.getLogger(TelaCocaCola.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        CocaColaDao bdao = new CocaColaDao();
        CocaColaBean bda = new CocaColaBean();

        if(jTabelaCocaCola.getSelectedRow() != -1){

            bda.setId((int) jTabelaCocaCola.getValueAt(jTabelaCocaCola.getSelectedRow(), 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCocaCola.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCocaCola().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTabelaCocaCola;
